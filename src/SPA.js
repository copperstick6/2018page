    ...
    return (
      ...
      <Header />
        ...
        <div className="About">
          ...
          <br />
          <p>I believe in helping people who are less priveleged than me. <b>Because we should always consider and help those who aren&#39;t as lucky as us.</b></p>
          <br />
          <p>And I believe in <b>love</b> loving yourself and everyone around you.</p>
          <br />
          <hr />
          <p><b>UTCS &#39;19</b></p>
          <p>SWE <i class="fab fa-amazon"></i> July &#39;19- </p>
         ...
         <a style={{color: "black"}} href="/resume"><i class="far fa-file-alt fa-2x"></i></a>&nbsp;&nbsp;
         </p>
         <br />
         <h2><a style={{color: "black"}} href="/resume">Resume</a></h2>
         </div>
        </main>
        <footer>
        <center>
